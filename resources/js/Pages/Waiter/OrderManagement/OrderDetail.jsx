...
const OrderDetail = ({ selectedOrder, setSelectedOrder }) => {
    ...
    const handleDelete = () => {
        ...
        router.delete(route("waiter.orders.destroy", selectedOrder.id), {
            preserveScroll: true,
            onSuccess: () => {
        ...
        <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div className="overflow-hidden flex items-center gap-5 flex-col">
                    ...
                    <div className="flex flex-col items-start gap-5 w-full justify-center">
                        ...
                        <Button
                            ...
                            className={`${Styles.button} w-full bg-slate-300 hover:bg-slate-200 text-gray-900`}
                        >
                            Allow Edit Order
                        </Button>
                        ...
                        <Button
                            ...
                            className={`${Styles.button} w-full bg-red-500 hover:bg-red-600 text-gray-100`}
                        >
                            Remove Order
                        </Button>
                    </div>
